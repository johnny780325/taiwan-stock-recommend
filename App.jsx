...
const STOCK_DB = {
  ...
  "6770":{n:"力積電",    alias:["psmc"],                  th:"記憶體",   sc:"晶圓代工",  px:52,   ch:1.5,  pct:2.97,  divs:[D("2025","2026/07/預計",0.5,0.96)]},
  ...
  "00878":{n:"國泰永續高息",alias:["00878"],              th:"高息ETF",  sc:"ETF",       px:24.01,ch:0.21, pct:0.88,  divs:[D("2026Q1","2026/02/18",0.42,1.80,"2/17","2026/03/12")]},
  // ╔═ 指數ETF ═╗
